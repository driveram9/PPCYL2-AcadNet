...
def login_view(request):
    ...
    if request.method == 'POST':
        ...
        if usuario in usuarios["estudiantes"]: #Se verifica si el usuario asignado pertenece a estudiantes, de no ser asi pasa al siguiente if de tutores
            if contrasenia == usuarios["estudiantes"][usuario]["contrasenia"]: #Despues de validar usuario valida la contraseña
        ...
        if usuario in usuarios["tutores"]:#Se verifica si el usuario asignado pertenece a tutores, de no ser asi pasa al siguiente if de usuario erroneo
            if contrasenia == usuarios["tutores"][usuario]["contrasenia"]:#Despues de validar usuario valida la contraseña
